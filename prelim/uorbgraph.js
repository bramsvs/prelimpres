var _transitions = [
  {
    transitionForward: () => dispatchMouseout("ekf2"),
  },
  {
    transitionForward: () => dispatchMouseover("ekf2"),
  },
  {
    transitionForward: () => dispatchMouseover("vehicle_attitude"),
  },
  {
    transitionForward: () => dispatchMouseover("vehicle_attitude_setpoint"),
  },
  {
    transitionForward: () => dispatchMouseover("mc_pos_control"),
  },
  {
    transitionForward: () => dispatchMouseover("mc_att_control"),
  },
  {
    transitionForward: () => dispatchMouseout("mc_att_control"),
  },
  {
    transitionForward: () => dispatchMouseout("actuator_controls_0"),
  }
]

function dispatchMouseover(name) {
  d3.selectAll('text').filter(d => d.name == name).dispatch('mouseover')
}

function dispatchMouseout(name) {
  d3.selectAll('text').filter(d => d.name == name).dispatch('mouseout')
}
...
function initializeGraph() {
  ...
  var default_json_file = 'graph_px4fmu-v4.json';
  ...
  function loadSimulation(json_file_name) {
    ...
    d3.json(json_file_name, function (error, graph) {
      ...
      */
      ...
      window.fadeAnimated = fadeAnimated;
